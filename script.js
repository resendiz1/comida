const menu = {
  tortas: [
    { name: 'Torta de jamón', desc: 'Jamón de pierna, queso panela, lechuga y jitomate', price: 45, imgs: ['img/torta_de_jamon.jpeg'] },
    { name: 'Torta de pierna', desc: 'Pierna de cerdo adobada, guacamole y frijoles', price: 50, imgs: ['img/torta_de_pierna.jpeg'] },
  ],
  desayunos: [
    ...
    { name: 'Chilaquiles verdes', desc: 'Totopos bañados en salsa verde, crema y queso', price: 65, imgs: ['img/chilaquiles_verdes.jpeg'] },
  ...
  comida: [
    { name: 'Comida corrida', desc: 'Guisado del día, arroz, frijoles y tortillas', price: 75, imgs: ['img/comida_corrida.jpeg'] },
    { name: 'Mole con pollo', desc: 'Pechuga de pollo bañada en mole poblano con arroz', price: 85, imgs: ['img/mole_con_pollo.jpeg'] },
    { name: 'Pechuga empanizada', desc: 'Pechuga empanizada con ensalada y papas', price: 80, imgs: ['img/pechuga_empanizada.avif'] },
  ],
  postres: [
    { name: 'Flan napolitano', desc: 'Flan cremoso con caramelo', price: 35, imgs: ['img/flan_napolitano.avif'] },
    { name: 'Gelatina de mosaico', desc: 'Gelatina de leche con cuadros de colores', price: 25, imgs: ['img/gelatina_de_mosaico.jpeg'] },
    ...
    { name: 'Arroz con leche', desc: 'Arroz con leche tradicional canela y pasas', price: 30, imgs: ['img/arroz_con_leche.jpg'] },
  ],
  antojitos: [
    { name: 'Sopes', desc: 'Sopes de masa con frijoles, crema, queso y salsa', price: 20, imgs: ['img/sopes.avif'] },
